...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for AI Action Studio (AIActionStudio.com).",
    ...
    <section className="py-16 md:py-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose-awb mt-8">
          ...
          <p>
            Site content, branding, and materials are owned by AI Action Studio unless otherwise noted.
          ...
          <h2>Contact</h2>
          <p>
            <a href="mailto:hello@aiactionstudio.com">hello@aiactionstudio.com</a>
          </p>
        </div>
      </div>
    </section>
